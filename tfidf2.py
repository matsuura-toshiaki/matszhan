...
Original file is located at
    https://colab.research.google.com/drive/1d7JtA4WZ4LrCCQKD0hvklalkWRULxkh2
"""
...
def save_dic(fname):
  #辞書をファイルへ保存
  pickle.dump(
      [word_dic,dt_dic,files],open(fname,"wb"))
...
if __name__=='__main__':
  ...
  print(calc_files())
  print(word_dic)
  save_dic('genre-tdidf.dic')
  load_dic('genre-tdidf.dic')